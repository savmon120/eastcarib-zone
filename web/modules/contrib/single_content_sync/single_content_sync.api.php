...
/**
 * Subscribe to BulkExportRoutesEvent to alter bulk export action routes.
 *
 * @code
 ...
 *   $event->addRoute('my_module.content_overview', 'node');
 *   $event->addRoute('my_module.article_overview', 'node', 'article');
 *   $event->removeRoute('entity.user.collection');
 * }
 * @endcode
 *
 * @see \Drupal\single_content_sync\Event\BulkExportRoutesEvent
 */
